...
Każdy oblany test należy zaznaczyć i co 3-ci rzucić jedną kością - wynik 1 lub 2 oznacza, że nasza Ciemna Strona na stałe zwiększyła się o 1.

Ciemna Strona ma swoje plusy - gracz może celowo jej użyć w grze, wtedy dostaje bonus +1 do Kliszy w trakcie trwania danej akcji. Np. Ciemna Strona to _Ryzyko (1)_, gracz celowo używa jej. Gracz ma teraz +1 do Kliszy i z krzykiem na ustach rzuca się na 3 gobliny broniące wejścia do tunelu. Zamiast _Wojownik (3)_ ma _Wojownik(4)_, Ciemna Strona dała mu +1. Minusem jest fakt, że po celowym użyciu Ciemnej Strony należy sprawdzić czy nie zwiększyła się ona o 1.
