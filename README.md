...
Przy tworzeniu postaci wydając 1 punkt można zamiast Kliszy kupić Szczęśliwy Traf. Za 2 punkty mamy dwa Szczęśliwe Trafy itd. Dzięki temu podczas gry wydając Szczęśliwy Traf możemy w 1 rzucie dodać sobie 1 kość "extra". Szczęśliwe Trafy resetują się pomiędzy przygodami.

- Ciemna Strona

Każda postać może posiadać jedną Kliszę (1) tzw. Ciemną Stronę - coś co ją pociąga w złą stronę. Może to być bogactwo, władza, kobiety, hazard, walka, wiedza, magia itd, wszystko co może nas sprowadzić na manowce - czyli wszystko :) Może też być "Nienawiść do orków", ryzyko, i tak dalej. W trakcie gry jeśli jesteśmy w sytuacji, która związana jest z naszą słabością (np. chcemy aresztować ważnego przeciwnika, mówi on do nas "dam Ci władzę, pięniądze, co tylko chcesz", a nasza Ciemna Strona to właśnie jedna z tych rzeczy), wtedy powinniśmy wykonać test Ciemnej Strony, jeśli się nie powiedzie - ulegliśmy. Mistrz Gry decyduje, czy zgadzamy się na propozycję, czy mamy tylko -1 do testów w wyniku rozproszenia (nasze Klisze traktujemy jak o 1 niższe). 
